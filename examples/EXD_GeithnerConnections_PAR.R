...
### Figure 1: MSPE
pdf("plot/Geithner_MSPE_PAR.pdf", width=6, height=6)
...
fileConn = file("plot/GeithnerResultTable_PAR.txt")
...
pdf("plot/GeithnerAR_FisherTest_PAR.pdf", width=10, height=6)
...
fileConn = file("plot/outputCI0_PAR.txt")
...
fileConn = file("plot/outputCI10_PAR.txt")
